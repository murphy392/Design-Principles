...
class MainTabBarController: UITabBarController {
	...
	private func makeSentTransfersList() -> ListViewController {
        ...
        vc.service = SentTransfersAPIItemServiceAdapter(api: TransfersAPI.shared, select: {
            [ weak vc ] item in
	...
	private func makeReceivedTransfersList() -> ListViewController {
        ...
        vc.service = ReceivedTransfersAPIItemServiceAdapter(api: TransfersAPI.shared, select: {
            [ weak vc ] item in
            vc?.select(transfer: item)
        })
